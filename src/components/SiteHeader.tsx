    ...
    <header className="relative z-10 flex items-center justify-between gap-3 px-4 pt-5 sm:px-6">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        {isAdmin ? (
          <Link
            to="/admin"
            className="glass-panel hidden items-center gap-2 rounded-xl px-3 py-2 text-cyan sm:flex sm:w-auto sm:px-3"
        ...
        {user ? (
          <button
            ...
            onClick={signOut}
            aria-label="Sign out"
            className="glass-panel hidden size-10 place-items-center rounded-xl text-subtle sm:grid"
          >
          ...
          <Link
            to="/auth"
            aria-label="Sign in"
            className="glass hidden size-10 place-items-center rounded-xl text-subtle sm:grid sm:w-auto sm:gap-2 sm:px-3"
          >
